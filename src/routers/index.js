...
import bookRoter from './book'
import collectRoter from './collection'
import mineRoter from './mine'
import Login from '../views/Login'
import RegisterRoter from '../views/Register'
    ...
    routes: [
		{
		  ...
		  path: '/register',
		  name: 'RegisterRoter',
		  component: RegisterRoter
		},
        bookRoter,
        collectRoter,
        mineRoter,
        // 重定向：当上面路由都不匹配的情况下，跳转到book页面
        {
            path:'/*',
            redirect:'/book'
        }
